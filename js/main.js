        ...
        if ($('#username-input').val() != '') {
            if ($selected_platform != '') {
				...
				$('#csr-generator').fadeOut(700, function() {
					...
					sweetAlert("Error", "Please select your Gems.", "error");
				}	
            } else {
...
$(document).ready(function() {
    ...
    $('#X00ButtonChat')['click'](function() {
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + '  </span>  lol stop wasting ur time and take your free Clash Royale Resources');

                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + '  </span>  is this your first time here? this is like the only legit Clash Royale Resources generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + '  </span> ' + ' he just wants all Clash Royale Resources for himself haha');
